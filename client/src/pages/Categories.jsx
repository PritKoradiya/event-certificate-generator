const categories = [
  ...
  {
    name: "Hackathon",
    explanation: "For coding sprints, innovation challenges, and prototype building events.",
    example: "Smart City Hackathon",
    templates: "1+ related templates"
  },
  {
    name: "Training",
    explanation: "For internship, training, and course completion certificates.",
    example: "Full Stack Development Training",
    templates: "3+ related templates"
  },
  {
    name: "Competition",
    explanation: "For coding contests, project challenges, and competitive events.",
    example: "Intercollege Coding Competition",
    templates: "3+ related templates"
  },
  {
    name: "Appreciation",
    explanation: "For recognizing contribution, support, and volunteer service.",
    example: "Volunteer Appreciation Drive",
    templates: "2+ related templates"
  },
  {
    name: "Academic",
    explanation: "For achievement, excellence, and academic recognition certificates.",
    example: "Academic Excellence Award",
    templates: "4+ related templates"
  },
  {
    name: "Cultural",
    explanation: "For cultural programs, performances, and creative events.",
    example: "Annual Cultural Fest",
    templates: "1+ related templates"
  },
  {
    name: "Sports",
    explanation: "For sports days, tournaments, and athletic achievements.",
    example: "Interdepartment Cricket Tournament",
    templates: "1+ related templates"
  },
  {
    name: "Technical",
    explanation: "For technical festivals, demos, project exhibitions, and club events.",
    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
        {categories.map((category) => (
          <div key={category.name} className="rounded-lg border border-slate-200 bg-white p-5 shadow-soft transition hover:-translate-y-1 hover:shadow-lg">
